...
public class FaqTest {
    ...
    public FaqTest(String questionText, String checkedText) {
        this.questionText = questionText;
        this.answerText = checkedText;
    }
    ...
    @Test
    public void faqSearchAndAssert() {
        ...
        MainPage mainPage = new MainPage(driver)
                ...
                .scrollToFaq()
                .checkAboutFaqText()
                .checkQuestionsAndAnswers(questionText,answerText);
